// his problem is the same as the previous but introduces the concept of
...
function makeItModular() {
  ...
  readDirAndFilter(path, ext, function(err, list) {
    if (!err) {
      printList(list);
    }
  });
